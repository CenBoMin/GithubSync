...
!(async () => {
  ...
  $.log('', '', `-------------------------\n\n🥦 URl 测试完成,测试请求全部结束`)
  $.msg('', '', `🥦 葱花视频时段奖励共计获得${readscore}个金币，请求全部结束`)
})()
  .catch((e) => $.logErr(e))
  .finally(() => $.done())
  ...
  return new Promise((resolve, reject) => {
    ...
    $.post(url, async (error, response, data) => {
      ...
      if (readres.code == '200') {
        ...
        console.log(readres.data.score)
        console.log(readres.data.my_score)
