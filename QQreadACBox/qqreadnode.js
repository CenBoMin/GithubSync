...
12.28 固定ck版,增加外部通知，默认12点以及23.40通知，解决宝箱翻倍问题
...
function showmsg() {
  return new Promise(async resolve => {
    if (BOX==0){
	$.msg(O, "", tz);
	if (nowTimes.getHours() === 12 && (nowTimes.getMinutes() >= 0 && nowTimes.getMinutes() <= 15)||nowTimes.getHours() === 23 && (nowTimes.getMinutes() >= 40 && nowTimes.getMinutes() <= 59))
