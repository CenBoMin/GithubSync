//说明
1.第一次务必绑定微信,扫图片二维码加我好友会登入微信页面,然后在下载APP，到我的'点击头像',退出登录...就会弹出绑定微信的页面
2.提现脚本定时cron务必设置在凌晨零点(00:00-00:59),并且切记不要在凌晨零点(00:00-01:00)这段时间手动执行脚本
3.这个毛看运气,基本应该有1元,还有一些优惠折扣商品
